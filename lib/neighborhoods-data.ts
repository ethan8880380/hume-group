...
export const neighborhoodsData: NeighborhoodData[] = [
    ...
    sections: [
      {
        ...
        content: "University Place boasts some of Pierce County's highest-rated schools, making it a magnet for families seeking quality education. The area's low crime rates and well-maintained neighborhoods add to its appeal.",
        image: "/images/neighborhoods/3.png",
        imagePosition: "right",
      },
      {
        title: "Shopping & Dining Convenience",
        content: "From Bridgeport Village to the University Place Town Center, residents enjoy easy access to shopping, dining, and entertainment. Everything you need is just minutes away.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "North Slope features some of Tacoma's most beautiful historic homes, many lovingly restored with modern amenities. The neighborhood's architectural diversity—from Tudor to Craftsman—adds to its unique character.",
        image: "/images/house.png",
        imagePosition: "left",
      },
    ],
  ...
  },
  {
    ...
    description: "Old Town and Ruston offer unique waterfront living along Commencement Bay. These neighborhoods blend industrial history with modern development, featuring scenic parks, waterfront trails, and stunning views of the Olympic Mountains and Puget Sound.",
    ...
    sections: [
      {
        ...
        content: "Wake up to views of Commencement Bay, the Olympic Mountains, and stunning sunsets. The Ruston Way waterfront trail offers miles of scenic walking and biking with beach access and parks along the way.",
