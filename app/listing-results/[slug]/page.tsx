...
const neighborhoodWidgets: Record<string, string> = {
  ...
  "university-place-fircrest": `<bb-widget data-type="FeaturedGallery" data-filter="mls_id:wa555+listing_status:active+city:fircrest,university place+limit:12+order:price"></bb-widget>
`,
  ...
  "ups-tacoma-north-slope": `<bb-widget data-type="FeaturedGallery" data-filter="mls_id:wa555+listing_status:active+area:21 - north tacoma,22 - north tacoma+limit:12+order:price"></bb-widget>`,
